...
CORE_VOCABULARY = [
    ...
    # Body parts
    "head", "eye", "ear", "nose", "mouth", "tooth", "tongue", "hand", 
    "foot", "leg", "arm", "back", "belly", "neck", "heart", "blood",
    ...
    "see", "hear", "know", "think", "say", "give", "take", "make", "kill",
    "die", "live", "love", "fear", "laugh", "cry", "sing", "dance",
    ...
    # Basic concepts
    "name", "house", "road", "food", "meat", "bone", "egg", "fat",
    "salt", "knife", "rope", "skin", "feather", "hair", "horn", "tail",
