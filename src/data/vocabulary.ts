export const CORE_VOCABULARY = [
  ...
  // Nature
  "tree", "leaf", "root", "bark", "flower", "grass", "water", "fire", "earth", 
  "stone", "sand", "sun", "moon", "star", "sky", "cloud", "rain", "snow", 
  "wind", "mountain", "river", "sea", "lake",

  // Actions
  "eat", "drink", "sleep", "walk", "run", "sit", "stand", "come", "go", "see", 
  "hear", "know", "think", "say", "give", "take", "make", "kill", "die", "live", 
  "love", "fear", "laugh", "cry", "sing", "dance",

  // Qualities
  "big", "small", "long", "short", "wide", "narrow", "thick", "thin", "heavy", 
  "light", "hot", "cold", "warm", "cool", "wet", "dry", "good", "bad", "new", 
  "old", "young", "right", "wrong", "clean", "dirty",
  ...
  // Basic concepts
  "name", "house", "road", "food", "meat", "bone", "egg", "fat", "salt", "knife", 
  "rope", "skin", "feather", "hair", "horn", "tail",

  // Abstract
  "life", "death", "dream", "fear", "love", "anger", "peace", "war", "truth", 
  "lie", "hope", "pain", "joy", "work", "play", "hunt",
];
